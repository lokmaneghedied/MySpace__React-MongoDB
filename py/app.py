...
def edit_post():
    ...
    if post_title != '' and post_content != '' :
        mongo.db.posts.update_one({"_id": ObjectId(post_id)}, {"$set": {"title": post_title, "content": post_content}})
        return 'h'
    elif post_title != '' and post_content == '' :
        mongo.db.posts.update_one({"_id": ObjectId(post_id)}, {"$set": {"title": post_title}})
        return 'h'
    elif post_title == '' and post_content != '' :
        mongo.db.posts.update_one({"_id": ObjectId(post_id)}, {"$set": {"content": post_content}})
        return 'h'
    else :
        return 'h'
